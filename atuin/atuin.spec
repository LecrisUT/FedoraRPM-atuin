...
%global upstream_version 18.5.0-beta.2
...
URL:            https://atuin.sh
Source:         https://github.com/atuinsh/atuin/archive/refs/tags/%{upstream_version}.tar.gz
...
%prep
%autosetup -n atuin-%{upstream_version} -p1
%cargo_prep
